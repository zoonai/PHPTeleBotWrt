...
$oc_secret = shell_exec('uci get openclash.config.dashboard_password'); // '110420';
...
curl_setopt($ch, CURLOPT_URL, 'http://10.0.0.1:9090/providers/proxies');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
$headers[] = 'Authorization: Bearer 110420';
$headers[] = 'Connection: keep-alive';
$headers[] = 'Content-Type: application/json';
$headers[] = 'Cookie: filemanager=ee057d392316be9bec05f297f2037536';
$headers[] = 'Referer: http://10.0.0.1:9090/ui/yacd/?hostname=10.0.0.1&port=9090&secret=110420';
$headers[] = 'Sec-Gpc: 1';
...
curl_setopt($ch, CURLOPT_URL, 'http://10.0.0.1:9090/rules');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
